...
import (
	...
	"github.com/kuartis/rtp_go/codecs"
)
...
func TestPacketizer(t *testing.T) {
	...
	packets := packetizer.Packetize(multiplepayload, 2000, globalMathRandomGenerator.Uint32())
...
func TestPacketizer_AbsSendTime(t *testing.T) {
	...
	packets := pktizer.Packetize(payload, 2000, globalMathRandomGenerator.Uint32())
